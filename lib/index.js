...
function fromFileWithPath( filePath, type, options, cb ) {
  var type;
...
function fromUrl( url, options, cb ) {
  var urlNoQueryParams, extname, filePath, fullFilePath, file, type;
  ...
  if ( typeof url === 'string' ) {
    ...
    file.on( 'finish', function() {
      fromFileWithPath( fullFilePath, type, options, cb );
    });
    got( url )
